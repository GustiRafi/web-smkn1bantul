                    ...
                    <div class="px-3 pt-3">
                        <div data-aos="fade-right">
                            <div class="d-flex my-3">
                                ...
                                <h4 class="ps-3">Sambutan Kepala Sekolah</h4>
                            </div>
                        </div>
                        <div data-aos="fade-right">
                            <div class="mt-3">
                                <p class="pt-3">Assalamualaikum Wr Wb.</p>
                                <p>Selamat datang di web SMK Negeri 1 Bantul dengan motto My School Zero Waste Green Is
                                    Life. Sekolah Saya Indah, Tidak Ada Sampah, Suasana Hijau, Segar Adalah Kehidupanku.
                                    Silahkan kunjungi web kami. Percayakan siswa siswi, putra putri bapak ibu untuk
                                    sekolah di SMK Negeri 1 Bantul. Kami siap untuk mengemban amanah dari masyarakat,
                                    mengantarkan siswa siswi kami menjadi orang yang sukses di masa depan. SMK BISA, SMK
                                    HEBAT, SMK BISA HEBAT, SMK Negeri 1 Bantul siap untuk mengantarkan putra putri Anda
                                    di jenjang kesuksesan.
                                    Terimakasih.</p>
                                <p>Wassalamualaikum Wr Wb.</p>
                                <div class="row row-cols-1 float-end">
                                    <div class="col">
                                        <p>Kepala SMK N 1 Bantul</p>
                                        <p>ttd</p>
                                        <p>Mujari, S.Pd., M.Pd.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
